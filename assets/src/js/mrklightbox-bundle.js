! function(e, n) {
    ...
    return function() {
        ...
        "object" === ("undefined" == typeof document ? "undefined" : B(document)) && ((n = document.createElement("style")).className = o, n.appendChild(document.createTextNode(".mrklightbox-fade-in{animation:mrklightbox-fade-in .3s cubic-bezier(0,0,.7,1)}.mrklightbox-fade-out{animation:mrklightbox-fade-out .3s ease}.mrklightbox-fade-in-strong{animation:mrklightbox-fade-in-strong forwards .3s cubic-bezier(0,0,.7,1)}.mrklightbox-fade-out-strong{animation:mrklightbox-fade-out-strong .3s ease}@keyframes mrklightbox-fade-in{from{opacity:.65}to{opacity:1}}@keyframes mrklightbox-fade-out{from{opacity:.35}to{opacity:0}}@keyframes mrklightbox-fade-in-strong{from{opacity:.3}to{opacity:1}}@keyframes mrklightbox-fade-out-strong{from{opacity:1}to{opacity:0}}.mrklightbox-absoluted{position:absolute;top:0;left:0}.mrklightbox-cursor-grabbing{cursor:grabbing!important}.mrklightbox-full-dimension{width:100%;height:100%}.mrklightbox-open{overflow:hidden;height:100%}.mrklightbox-flex-centered{display:flex;justify-content:center;align-items:center}.mrklightbox-opacity-0{opacity:0!important}.mrklightbox-opacity-1{opacity:1!important}.mrklightbox-scrollbarfix{padding-right:17px}.mrklightbox-transform-transition{transition:transform .3s!important}.mrklightbox-container{font-family:Arial,sans-serif;position:fixed;top:0;left:0;background:linear-gradient(rgba(30,30,30,.9),#000 1810%);touch-action:none;z-index:1000000000;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-webkit-tap-highlight-color:transparent}.mrklightbox-container *{box-sizing:border-box}.mrklightbox-svg-path{transition:fill .15s ease;fill:#d1d2d2}.mrklightbox-loader{display:block;margin:auto;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:67px;height:67px}.mrklightbox-loader-child{box-sizing:border-box;display:block;position:absolute;width:54px;height:54px;margin:6px;border:5px solid;border-color:#999 transparent transparent transparent;border-radius:50%;animation:mrklightbox-loader 1.2s cubic-bezier(.5,0,.5,1) infinite}.mrklightbox-loader-child:nth-child(1){animation-delay:-.45s}.mrklightbox-loader-child:nth-child(2){animation-delay:-.3s}.mrklightbox-loader-child:nth-child(3){animation-delay:-.15s}@keyframes mrklightbox-loader{0%{transform:rotate(0)}100%{transform:rotate(360deg)}}.mrklightbox-thumbs-loader{width:54px!important;height:54px!important}.mrklightbox-thumbs-loader div{border-width:4px!important;width:44px!important;height:44px!important}.mrklightbox-nav{height:45px;width:100%;transition:opacity .3s}.mrklightbox-slide-number-container{display:flex;justify-content:center;align-items:center;position:relative;height:100%;font-size:15px;color:#d7d7d7;z-index:0;max-width:55px;text-align:left}.mrklightbox-slide-number-container .mrklightbox-flex-centered{height:100%}.mrklightbox-slash{display:block;margin:0 5px;width:1px;height:12px;transform:rotate(15deg);background:#fff}.mrklightbox-toolbar{position:absolute;z-index:3;right:0;top:0;height:45px;display:flex;background:rgba(35,35,35,.65)}.mrklightbox-toolbar-button{height:100%;width:45px;cursor:pointer}.mrklightbox-toolbar-button:hover .mrklightbox-svg-path{fill:#fff}.mrklightbox-slide-btn-container{display:flex;align-items:center;padding:12px 12px 12px 6px;position:absolute;top:50%;cursor:pointer;z-index:3;transform:translateY(-50%);transition:opacity .3s}@media (min-width:476px){.mrklightbox-slide-btn-container{padding:22px 22px 22px 6px}}@media (min-width:768px){.mrklightbox-slide-btn-container{padding:30px 30px 30px 6px}}.mrklightbox-slide-btn-container:hover .mrklightbox-svg-path{fill:#f1f1f1}.mrklightbox-slide-btn{padding:9px;font-size:26px;background:rgba(35,35,35,.65)}@media (min-width:768px){.mrklightbox-slide-btn{padding:10px}}@media (min-width:1600px){.mrklightbox-slide-btn{padding:11px}}.mrklightbox-slide-btn-container-previous{left:0}@media (max-width:475.99px){.mrklightbox-slide-btn-container-previous{padding-left:3px}}.mrklightbox-slide-btn-container-next{right:0;padding-left:12px;padding-right:3px}@media (min-width:476px){.mrklightbox-slide-btn-container-next{padding-left:22px}}@media (min-width:768px){.mrklightbox-slide-btn-container-next{padding-left:30px}}@media (min-width:476px){.mrklightbox-slide-btn-container-next{padding-right:6px}}.mrklightbox-down-event-detector{position:absolute;z-index:1}.mrklightbox-slide-swiping-hoverer{z-index:4}.mrklightbox-slideshow-bar{width:0;height:2px;z-index:4;opacity:0;background:#fff}.mrklightbox-invalid-file-wrapper{font-size:24px;color:#eaebeb;margin:auto}.mrklightbox-video{object-fit:cover}.mrklightbox-youtube-iframe{border:0}.mrklightbox-source{position:relative;z-index:2;display:block;opacity:0;margin:auto;cursor:zoom-in}.mrklightbox-source-wrappers-container{transition:transform .2s linear;z-index:2}.mrklightbox-source-wrappers-container-pinching{transition:none!important}.mrklightbox-thumbs{position:absolute;bottom:0;left:0;width:100%;z-index:-1;background:linear-gradient(180deg,rgba(0,0,0,0),#1e1e1e 100%);opacity:0;transition:opacity .2s;padding:0 5px 12px 5px;height:114px}@media (min-width:992px){.mrklightbox-thumbs{padding-bottom:13px;height:120px}}@media (min-width:1600px){.mrklightbox-thumbs{padding-bottom:14px;height:126px}}.mrklightbox-thumbs-active{opacity:1;z-index:3}.mrklightbox-thumbs-inner{display:inline-flex;justify-content:flex-start;align-items:center;height:100%}.mrklightbox-thumb-wrapper{position:relative;height:100%;margin:0 4px;opacity:0;transition:opacity .3s}.mrklightbox-thumb-wrapper svg{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);cursor:pointer;z-index:1}.mrklightbox-thumb-wrapper path{fill:#fff}.mrklightbox-thumb-wrapper-darkener{position:absolute;top:2px;left:2px;width:calc(100% - 4px);height:calc(100% - 4px);background:rgba(0,0,0,.4);cursor:pointer}.mrklightbox-thumb{cursor:pointer;border-radius:1px;height:100%;width:auto!important;border:2px solid transparent;max-width:unset;max-height:unset}.mrklightbox-thumb-active{border:2px solid #fff!important}.mrklightbox-thumb-invalid{background:linear-gradient(to bottom,#0f0f0f,rgba(15,15,15,.5));display:inline-block;min-width:155px}.mrklightbox-thumbs-cursorer{z-index:4;cursor:grabbing}.mrklightbox-caption{position:absolute;bottom:0;left:50%;width:100%;background:linear-gradient(180deg,rgba(0,0,0,0),#1e1e1e 100%);transform:translateX(-50%);opacity:0;transition:opacity .2s;z-index:-1}.mrklightbox-caption-inner{padding:25px;max-width:1200px;color:#eee;text-align:center;font-size:14px}@media (min-width:768px){.mrklightbox-caption-inner{padding:30px 25px}}.mrklightbox-caption-active{opacity:1;z-index:3}")), document.head.appendChild(n));
        var k = "mrklightbox-types",
            H = "mrklightbox-scrollbar-width";
        ...
        function ne(e, n, t) {
            var o = e.elements,
                r = o.thumbsWrappers,
                i = o.thumbsInner;
            r[n] = document.createElement("div"), r[n].className = F, ee(e, r[n], n),
                function(e, n, t, o) {
                ...
                u = a[c] ? function() {
                    ...
                    return function(e, n) {
                        var t = e.elements,
                            o = t.thumbsWrappers,
                            r = t.thumbsInner;
                        o[n] = document.createElement("div"), o[n].className = "".concat(P, " ").concat(F), ee(e, o[n], n),
                            function(e, n, t) {
        ...
        function ae(e, n) {
            ...
            i[n] = document.createElement("div"), i[n].className = "".concat(u, " ").concat(r, " ").concat(s), o.appendChild(i[n]),
                function(e, n) {
                    var t = e.elements,
        ...
        function de(e) {
            var n = e.props.sources,
                o = e.elements;
            o.nav = document.createElement("div"), o.nav.className = "".concat(t, "nav"), o.container.appendChild(o.nav),
                function(e, n) {
                    var o = e.core,
                        r = o.clickZoomer,
                        i = r.zoomIn,
                    ...
                    d || le(h, p.thumbs, c.toggleThumbs), le(h, p.zoomIn, i), le(h, p.zoomOut, s),
                        function(e, n) {
        ...
        function he(e, n) {
            var t = e.core.slideChangeFacade,
                ...
                c = r[n];
            o[a] = document.createElement("div"), o[a].className = "".concat(d, " ").concat(d, "-").concat(n), o[a].title = c.title, o[a].onclick = t["changeTo".concat(i)],
                function(e, n) {
        ...
        function je(e) {
            ...
            o.isInitialized = !0, o.scrollbarWidth = function(e) {
                ...
                }(e), o.unloadedThumbsCount = d.length,
                function(e) {
                ...
                }(e)), Ze(e), i.container = document.createElement("div"), i.container.className = "".concat(t, "container ").concat(r, " ").concat(m),
                function(e) {
                    var n = e.elements;
        ...
        function en() {
            for (var e = document.getElementsByTagName("a"), n = function(n) {
                    if (!e[n].hasAttribute("data-mrklightbox")) return "continue";
                    var t = e[n].getAttribute("data-mrklightbox"),
                        o = e[n].getAttribute("href");
                    mrklightboxInstances[t] || (mrklightboxInstances[t] = new MrkLightbox);
                    var r = null;
                    "#" === o.charAt(0) ? (r = document.getElementById(o.substring(1)).cloneNode(!0)).removeAttribute("id") : r = o, mrklightboxInstances[t].props.sources.push(r), mrklightboxInstances[t].elements.a.push(e[n]);
                    var i = mrklightboxInstances[t].props.sources.length - 1;
                    e[n].onclick = function(e) {
                        e.preventDefault(), mrklightboxInstances[t].open(i)
                    ...
                    for (var s = ["href", "data-mrklightbox", "data-caption", "data-class", "data-custom-class", "data-type", "data-thumb", "data-video-poster"], a = e[n].attributes, c = mrklightboxInstances[t].props.customAttributes, u = 0; u < a.length; u++)
                    ...
                    function d(o, r) {
                        e[n].hasAttribute(r) && (mrklightboxInstances[t].props[o][i] = e[n].getAttribute(r))
                    }
                }, t = 0; t < e.length; t++) n(t);
            var o = Object.keys(mrklightboxInstances);
            window.fsLightbox = mrklightboxInstances[o[o.length - 1]]
        }
        return window.MrkLightbox = function() {
            var e = this;
            this.props = {
                sources: [],
        ...
        }, window.mrklightboxInstances = {}, en(), window.refreshMrklightbox = function() {
            for (var e in mrklightboxInstances) {
                var n = mrklightboxInstances[e].props;
                mrklightboxInstances[e] = new MrkLightbox, mrklightboxInstances[e].props = n, mrklightboxInstances[e].props.sources = [], mrklightboxInstances[e].elements.a = []
            }
            en()
        }, e
    }()
